    ...
    loadModel: function() {
      ...
      if(!this.fs.exists(modelsJsonPath)) {
        this.error(format(
          ...
          ' Run %s for create.',
          app, colors.green('./manage.py modelsjson ' + app)));
      }
    ...
    registerViews: function () {
      ...
      self.views.list = {
        ...
        urlpattern: format(
          ...
          self.modelName, self.modelName.toLowerCase()),
      ...
      self.views.detail = {
        ...
        urlpattern: format(
            ...
            this.isSlug ? '(?P<slug>[-a-zA-Z0-9_]+)' : '(?P<pk>\\d+)',  //jshint ignore:line
            self.modelName, self.modelName.toLowerCase()),
        viewContext: function () {
          var context = {
            appName: self.appName,
      ...
      self.views.create = {
        ...
        optionName: 'create',
        urlpattern: format('url(r\'^create/\', ' +
